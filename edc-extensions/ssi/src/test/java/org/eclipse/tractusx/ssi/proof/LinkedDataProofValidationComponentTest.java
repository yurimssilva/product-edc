...
import org.eclipse.tractusx.ssi.util.TestDidDocumentResolver;
...
public class LinkedDataProofValidationComponentTest {
    ...
    public void test() {
        ...
        didDocumentResolver.registerVerificationMethod(DID_TEST_OPERATOR, verificationMethod, publicKey);
